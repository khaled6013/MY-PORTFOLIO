...
const Banner = () => {
  return (
    <>
      <div className="lg:py-30 md:py-10 py-3 bg-[#E9E9E9]">
            ...
            <div className="lg:w-3/6 w-full mt-10 lg:mt-0">
              ...
              <div className="lg:mt-4 mt-3">
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-4 lg:gap-6 py-6">
                  <a href="#contact" className="flex items-center gap-2 text-white bg-linear-to-r from-blue-500 to-cyan-400 font-semibold px-6 py-3 rounded-full e hover:shadow-lg hover:shadow-blue-400/40 transition-all duration-300 cursor-pointer">
                    HIRE ME
